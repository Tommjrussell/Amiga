...
//#if 0
  ...
  #define res (vec2(672.0/1.0,272.0/1.0))
//#else
//  // Optimize for resize.
//  #define res (screenSize/6.0)
//#endif
...
void main()
{
	vec2 pos = Warp(fragCoord.xy / screenSize);
	pos -= vec2(0.0, scanlineOffset * 0.0036765);
	//{
	//	hardScan = -12.0;
